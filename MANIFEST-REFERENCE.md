...
| `slots` | string[] | yes | In v1 must include `"section"` (the only slot type that exists today — your widget occupies the full content area when active). Unknown slot names are ignored, for forward compatibility. ([§2](https://github.com/SchrodingerEQ/Rootboard.me/blob/main/docs/plans/widget-system/CONTRACT.md#2-manifest--widgetjson)) |
| `description` | string | no | ≤200 characters. Shown in the layout picker. ([§2](https://github.com/SchrodingerEQ/Rootboard.me/blob/main/docs/plans/widget-system/CONTRACT.md#2-manifest--widgetjson)) |
